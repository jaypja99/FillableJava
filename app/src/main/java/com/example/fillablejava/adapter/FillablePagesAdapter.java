package com.example.fillablejava.adapter;
...
import com.example.fillablejava.FillableLoaderPage;
...
public class FillablePagesAdapter extends FragmentStatePagerAdapter {
  ...
  private FillableLoaderPage getFragmentForPosition(int position) {
    switch (position) {
      case 0:
        return firstPage;
      case 1:
